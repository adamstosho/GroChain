...
export function USSDDashboard() {
  ...
  // Mock data
  const mockServiceInfo: USSDServiceInfo = {
    serviceCode: "*123#",
  ...
  const mockStats: USSDStats = {
    ...
    topFeatures: [
      { feature: "Market Prices", usageCount: 5670 },
      { feature: "Weather Info", usageCount: 4230 },
      { feature: "Loan Status", usageCount: 3120 },
      { feature: "Account Balance", usageCount: 2400 }
    ]
  }

  const mockActiveSessions: USSDSession[] = [
    {
      sessionId: "ussd_001",
      phoneNumber: "+2348012345678",
      status: "active",
      startTime: "2025-01-16T14:30:00Z",
      lastActivity: "2025-01-16T14:32:00Z",
      currentMenu: "Market Prices",
      network: "MTN"
    },
    {
      sessionId: "ussd_002", 
      ...
      status: "completed",
      startTime: "2025-01-16T14:25:00Z",
      lastActivity: "2025-01-16T14:28:00Z",
      currentMenu: "Weather Info",
      network: "Airtel"
    }
  ]
