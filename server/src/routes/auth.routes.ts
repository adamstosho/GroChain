...
import { register, login, refresh, forgotPassword, resetPassword, verifyEmail, resendVerificationEmail, sendSmsOtp, verifySmsOtp, logout } from '../controllers/auth.controller';
